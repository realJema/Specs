...
def execute(): 
    ...
    data['System_information'] = {"System": uname.system, "Node_name": uname.node, "Release": uname.release, "Version": uname.version, "Machine": uname.machine, "Processor": uname.processor}
